...
class LogisticGraph:
    ...
    def build_graph(self) -> CompiledStateGraph:
        ...
        orders_broker
            - Handles fruit order requests by extracting parameters from user input
    ...
    async def _orders_node(self, state: GraphState) -> dict:
        ...
        sys_msg = SystemMessage(
            content="""You are an orders broker for a global fruit exchange company.
    ...
    async def serve(self, prompt: str, intent_id: str | None = None):
        ...
        Args:
            ...
            intent_id (str | None): Cognition intent identifier carried through state for downstream nodes (iter 2: carry-only, no behavior).
        Returns:
    ...
    async def streaming_serve(self, prompt: str, intent_id: str | None = None):
        ...
        Args:
            prompt (str): User's order request (e.g., "I want to order 5000 lbs of fruit for $3.52")

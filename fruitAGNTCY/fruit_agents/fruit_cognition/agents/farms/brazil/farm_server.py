...
factory = AgntcyFactory("fruit_cognition.brazil_farm", enable_tracing=not OTEL_SDK_DISABLED)
...
async def serve_all_a2a_interfaces(
    ...
    """Serve the Brazil Mango Farm agent across all A2A transports defined in its AgentCard.

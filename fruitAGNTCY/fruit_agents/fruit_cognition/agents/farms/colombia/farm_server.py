...
factory = AgntcyFactory("fruit_cognition.colombia_farm", enable_tracing=True)
...
async def serve_all_a2a_interfaces(
    ...
    """Serve the Colombia Apple Farm agent across all A2A transports defined in its AgentCard.

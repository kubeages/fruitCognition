...
This guide explains how **Agntcy Identity TBAC (Tool-Based Access Control)** is integrated into the Acorda (FruitCognition) ecosystem. TBAC enables us to define, enforce, and audit authorization policies across multiple collaborating services, ensuring consistent and secure access control.
...
In FruitCognition, **service badges** represent the identity of each service in the auction workflow. Each badge includes identity attributes and roles used for authorization.

Badges created for the FruitCognition auction flow:
...
**Badges for FruitCognition Services:**
![Service Badges Screenshot](../images/identity_saas_fruit_cognition_badges.png)
...
**Policies for FruitCognition Services:**
![Policies Screenshot](../images/identity_saas_fruit_cognition_policies.png)
...
If using the demo environment, request keys from the FruitAGNTCY team or Agntcy Identity support.
...
Use the **FruitCognition UI** to trigger interactions and observe TBAC enforcement.
...
2. Re-run the above prompts in the FruitCognition UI

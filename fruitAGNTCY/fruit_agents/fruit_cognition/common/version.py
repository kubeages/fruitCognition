"""Version and dependency utilities for FruitCognition exchange service.
...
def get_version_info(properties_file_path: Path, app_name: str = "fruit-cognition-exchange", service_name: str = "fruit-cognition-exchange") -> dict:
